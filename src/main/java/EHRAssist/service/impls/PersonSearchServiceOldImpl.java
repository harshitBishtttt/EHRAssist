...
//import EHRAssist.dto.response.patientSearchResponse.SearchResponse;
//import EHRAssist.dto.response.patientSearchResponse.*;
...
//
//@Service
//public class PersonSearchServiceOldImpl {
//
...
//    }
//
//    public PatientSearchResponse searchPersonWithDynamicQuery(PersonRequest request) {
...
//    }
//
//    public PatientSearchResponse searchPerson(PersonRequest request, Pageable pageable) {
//        PatientSearchResponse person = new PatientSearchResponse();
//        NameInfoRequest name = request.getNameRequest();
//        AddressInfoRequest address = request.getAddress();
//        TelecomInfoRequest telecom = request.getTelecom();
...
//                telecom.getUseTel());
//        int count = data.size();
//        List<Entity> entityResponses = data.stream().map(ittr -> {
